...
<article class="flex gap-6 py-6">
    <a href="{{ $url }}" class="block h-28 w-28 shrink-0 overflow-hidden rounded bg-slate-100" aria-label="{{ e($title) }}">
    ...
    <div class="min-w-0">
        ...
        <a href="{{ $url }}" class="mt-2 inline-flex items-center gap-2 text-sm text-slate-700 hover:text-slate-900">
            <span>Read More</span>
            <span class="inline-flex h-5 w-5 items-center justify-center rounded-full bg-slate-200 text-slate-600">›</span>
        </a>
    </div>
</article>
