...
@section('content')
    @php
        ...
        $templateName = trim((string) data_get($post->meta_json ?? [], 'template', ''));
        $isAtelierTemplate = $templateName === 'atelier-home';
    ...
    @if ($isHomepage || $isAtelierTemplate)
        @push('head')
            <style>
                body.home #site-header,
                body.template-atelier-home #site-header,
                body.page-template-atelier-home #site-header {
                    background: transparent !important;
                    box-shadow: none !important;
                }

                body.home #site-header .site-header-main,
                body.template-atelier-home #site-header .site-header-main,
                body.page-template-atelier-home #site-header .site-header-main {
                ...
                body.home #site-header .site-header-nav,
                body.template-atelier-home #site-header .site-header-nav,
                body.page-template-atelier-home #site-header .site-header-nav {
                    overflow: visible;
                }

                body.home #site-header .site-header-nav .mega-menu-item>.mega-menu-panel,
                body.template-atelier-home #site-header .site-header-nav .mega-menu-item>.mega-menu-panel,
                body.page-template-atelier-home #site-header .site-header-nav .mega-menu-item>.mega-menu-panel {
                    background: #fff;
                    border-top: 3px solid #d32f2f;
                    box-shadow: 0 18px 40px rgba(15, 23, 42, 0.10);
                }

                body.home #site-header .cms-menu__item--depth-0>.cms-menu__link:hover,
                body.template-atelier-home #site-header .cms-menu__item--depth-0>.cms-menu__link:hover,
                body.page-template-atelier-home #site-header .cms-menu__item--depth-0>.cms-menu__link:hover {
    ...
    @if ($showCustomHero)
        @if ($isHomepage || $isAtelierTemplate)
            <section class="atelier-hero relative min-h-screen overflow-hidden bg-slate-900">
                @if ($heroBackgroundUrl)
                    <div class="atelier-hero-background absolute inset-0"
                        style="
